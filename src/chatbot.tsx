...
(function() {
  ...
  var CHATBOT_ID = 'cmoccoceo000404l1x3zw8t1z';
  var BASE_URL = 'https://app.agentive.co.in';
  var COLOR = '#4d3a2c';
  var POSITION = 'right';
  var GREETING = "Hi there! 👋 Welcome to Study in Keralam. Whether you're exploring colleges, need admission guidance, or have questions about 2026-27 admissions, I'm here to help. What can I assist you with today?";
  var NAME = "Study in Keralam Assistant";
  var BOTTOM = 20;
  var SIDE = 20;
  var PROACTIVE_ENABLED = false;
  var PROACTIVE_DELAY = 10;
  var PROACTIVE_MSG = "";
  var BTN_EFFECT = 'bounce';
  ...
  function toggleWidget(e: MouseEvent | TouchEvent) {
    e.stopPropagation();
    e.preventDefault();
